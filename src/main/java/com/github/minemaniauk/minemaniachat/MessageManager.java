...
public class MessageManager {
    ...
    public static void log(String message) {
        ...
        for (String string : message.split("\n")) {
            MineManiaChat.getInstance().getLogger().info(MessageManager.convertAndParse(string, null));
        }
    }
    ...
    public static void log(Component component) {
        MineManiaChat.getInstance().getLogger().info(component);
    }
    ...
    public static void warn(String message) {
        message = "&6" + message;
        for (String string : message.split("\n")) {
            MineManiaChat.getInstance().getLogger().warn(MessageManager.convertAndParse(string, null));
        }
    }
}
